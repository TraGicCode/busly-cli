...
using NServiceBusCLI.Console.Tests.EndToEnd.Infrastructure;
...
namespace NServiceBusCLI.Console.Tests.EndToEnd.RabbitMQ;
...
public class SendCommandRabbitMqEndToEndTests : RabbitMqEndToEndTestBase
{
    ...
    {
        var testEndpoint = await new TestEndpointFactory().CreateRabbitMQTestEndpoint(Container.GetConnectionString(),
